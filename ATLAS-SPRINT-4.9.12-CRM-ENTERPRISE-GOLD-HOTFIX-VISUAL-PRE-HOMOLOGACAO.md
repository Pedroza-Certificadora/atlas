...
## Entregas
- Cards da Central de Clientes no mesmo padrão do Dashboard;
- Ícones vetoriais SVG, consistentes e legíveis;
- Cores específicas por indicador;
- Todos os cards permanecem clicáveis;
- Botão **Excluir cliente** visível em **Mais opções**;
