...
(function (window, document) {
  "use strict";
  var build = Object.freeze({ product: "Portal Atlas", sprint: "5.0", module: "Agenda e Agendamentos", version: "5.0.7.1", environment: "Pre-Homologacao", publishedAt: "24/07/2026" });
  window.ATLAS_BUILD = build;
  function label(){ return "Atlas â€¢ Sprint " + build.sprint + " â€¢ " + build.module + " â€¢ v" + build.version; }
  function ensureGlobalStamp(){ var stamp=document.getElementById("atlas-build-stamp"); if(!stamp){ stamp=document.createElement("div"); stamp.id="atlas-build-stamp"; stamp.className="atlas-build-stamp"; stamp.setAttribute("role","status"); stamp.setAttribute("aria-label","VersÃ£o atual do Portal Atlas"); document.body.appendChild(stamp); } stamp.textContent=label(); }
  function ensureInstitutionalId(){
    ...
    line.textContent="Pedroza Certificadora â€¢ CNPJ: 57.938.005/0001-87";
