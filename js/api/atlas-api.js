...
(function (window) {
  ...
  window.AtlasAPI = Object.freeze({
    ...
    listAgenda: function (filters) { return request("agenda.list", filters || {}); },
    createAppointment: function (data) { return request("agenda.create", data); },
    updateAppointment: function (data) { return request("agenda.update", data); },
