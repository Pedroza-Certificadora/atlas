...
function buildPortalInviteEmail_(kind) {
  ...
  return '<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light"><meta name="supported-color-schemes" content="light"><title>'+title+'</title><style>html,body{margin:0!important;padding:0!important;width:100%!important;background:#edf3f8!important;color:#12345a!important}table{border-collapse:collapse!important}img{border:0;outline:none;text-decoration:none}a{text-decoration:none}@media only screen and (max-width:740px){.outer-pad{padding:0!important}.shell{width:100%!important;max-width:100%!important;border-left:0!important;border-right:0!important}.pad{padding-left:22px!important;padding-right:22px!important}.header-logo{width:230px!important}.hero-title{font-size:34px!important;line-height:1.08!important}.hero-copy{font-size:17px!important}.desktop-cell{display:block!important;width:100%!important;box-sizing:border-box!important}.portal-visual{margin-top:22px!important}.benefit{display:block!important;width:100%!important;border-right:0!important}.cta{display:block!important;width:100%!important;box-sizing:border-box!important}.footer-center{text-align:left!important}.mobile-full{width:100%!important;display:block!important;box-sizing:border-box!important}.mobile-hide{display:none!important}}@media (prefers-color-scheme:dark){.force-light{background:#ffffff!important;color:#12345a!important}.force-soft{background:#f1f7fb!important;color:#12345a!important}.force-navy{background:#0b3563!important;color:#ffffff!important}}</style></head><body bgcolor="#edf3f8" style="margin:0;padding:0;background:#edf3f8;color:#12345a;font-family:Arial,Helvetica,sans-serif;-webkit-text-size-adjust:100%;"><div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent">'+preheader+'</div><table role="presentation" width="100%" bgcolor="#edf3f8" cellspacing="0" cellpadding="0" border="0" style="width:100%;background:#edf3f8"><tr><td class="outer-pad" align="center" style="padding:30px 12px"><table role="presentation" class="shell force-light" width="720" bgcolor="#ffffff" cellspacing="0" cellpadding="0" border="0" style="width:720px;max-width:720px;background:#ffffff;border:1px solid #d5e1ec;box-shadow:0 12px 32px rgba(15,48,82,.08)"><tr><td class="pad force-light" bgcolor="#ffffff" style="padding:24px 38px 20px;border-bottom:4px solid #53ad2f"><table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td valign="middle"><img class="header-logo" src="'+logo+'" width="275" alt="Pedroza Certificadora" style="display:block;width:275px;max-width:100%;height:auto"></td><td class="mobile-hide" align="right" valign="middle" style="font-size:15px;line-height:1.35;font-weight:800;color:#0b3563">SEGURANÇA E CONFIANÇA<br><span style="color:#53ad2f;font-weight:600">PARA VOCÊ E SUA EMPRESA</span></td></tr></table></td></tr><tr><td class="pad force-soft" bgcolor="#f1f7fb" style="padding:42px 38px 38px;background:#f1f7fb"><table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td class="desktop-cell" width="59%" valign="middle" style="width:59%;padding-right:28px"><div style="font-size:12px;letter-spacing:1.8px;font-weight:900;color:#53ad2f">PEDROZA CERTIFICADORA</div><h1 class="hero-title" style="margin:11px 0 17px;font-size:43px;line-height:1.08;color:#0b3563">'+title+'</h1><p class="hero-copy" style="margin:0 0 13px;font-size:18px;line-height:1.5;color:#173f69">Olá, <strong>{{NOME}}</strong>.</p><p class="hero-copy" style="margin:0;font-size:17px;line-height:1.65;color:#46617c">'+intro+'</p></td><td class="desktop-cell" width="41%" valign="middle" style="width:41%"><table role="presentation" class="portal-visual" width="100%" bgcolor="#0b3563" cellspacing="0" cellpadding="0" style="width:100%;background:#0b3563;border-radius:16px"><tr><td align="center" style="padding:22px 18px 12px;color:#ffffff;font-size:12px;letter-spacing:1.4px;font-weight:800">PORTAL DO CLIENTE</td></tr><tr><td style="padding:0 18px 18px"><table role="presentation" width="100%" bgcolor="#ffffff" cellspacing="0" cellpadding="0" style="background:#ffffff;border-radius:10px"><tr><td style="padding:16px"><div style="height:8px;background:#e5edf4;border-radius:8px;margin-bottom:10px"></div><div style="height:8px;width:70%;background:#d2e2ef;border-radius:8px;margin-bottom:15px"></div><table role="presentation" width="100%"><tr><td width="48%" bgcolor="#eef6fb" style="padding:14px 8px;text-align:center;background:#eef6fb;border-radius:8px;color:#0b3563;font-size:12px;font-weight:800">VALIDADE</td><td width="4%"></td><td width="48%" bgcolor="#edf8e9" style="padding:14px 8px;text-align:center;background:#edf8e9;border-radius:8px;color:#39891e;font-size:12px;font-weight:800">AVISOS</td></tr></table></td></tr></table></td></tr><tr><td align="center" style="padding:0 18px 22px;color:#d9e7f3;font-size:13px;line-height:1.5">Certificado, histórico e atendimento em um só lugar.</td></tr></table></td></tr></table></td></tr><tr><td class="pad force-light" bgcolor="#ffffff" style="padding:32px 38px 12px"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #d8e4ee;border-radius:14px"><tr><td colspan="2" class="force-navy" bgcolor="#0b3563" style="padding:17px 20px;background:#0b3563;color:#ffffff;font-size:17px;font-weight:900">'+panelTitle+'</td></tr><tr><td class="benefit" width="50%" style="padding:18px 20px;border-right:1px solid #e1e9f0;border-bottom:1px solid #e1e9f0;color:#294b6d;font-size:15px;line-height:1.45"><strong style="color:#53ad2f">✓</strong> Avisos automáticos de vencimento</td><td class="benefit" width="50%" style="padding:18px 20px;border-bottom:1px solid #e1e9f0;color:#294b6d;font-size:15px;line-height:1.45"><strong style="color:#53ad2f">✓</strong> Consulta da validade do certificado</td></tr><tr><td class="benefit" width="50%" style="padding:18px 20px;border-right:1px solid #e1e9f0;color:#294b6d;font-size:15px;line-height:1.45"><strong style="color:#53ad2f">✓</strong> Atendimento humano e suporte remoto</td><td class="benefit" width="50%" style="padding:18px 20px;color:#294b6d;font-size:15px;line-height:1.45"><strong style="color:#53ad2f">✓</strong> Histórico e solicitação de renovação</td></tr></table></td></tr><tr><td class="pad force-light" bgcolor="#ffffff" align="center" style="padding:24px 38px 34px"><table role="presentation" cellspacing="0" cellpadding="0"><tr><td class="cta" bgcolor="#53ad2f" style="background:#53ad2f;border-radius:9px"><a class="mobile-full" href="'+buttonUrl+'" style="display:inline-block;padding:17px 32px;color:#ffffff;font-size:15px;font-weight:900">'+button+'</a></td></tr></table><div style="margin-top:16px;font-size:14px;line-height:1.5"><a href="'+whatsapp+'" style="color:#0b5f96;font-weight:800">Prefere falar com nossa equipe? Acesse o WhatsApp</a></div></td></tr><tr><td class="pad force-soft" bgcolor="#f1f7fb" style="padding:22px 38px;border-top:1px solid #dce6ef;color:#49637d;font-size:14px;line-height:1.65"><strong style="color:#0b3563">Segurança em primeiro lugar</strong><br>Seus dados são tratados de acordo com a LGPD. Nunca solicitaremos senha ou código de instalação do certificado por e-mail.</td></tr><tr><td class="pad force-light" bgcolor="#ffffff" style="padding:22px 38px;color:#49637d;font-size:14px;line-height:1.6">Atenciosamente,<br><strong style="font-size:16px;color:#0b3563">Equipe Pedroza Certificadora</strong></td></tr><tr><td class="pad force-navy footer-center" bgcolor="#0b3563" style="padding:20px 38px;background:#0b3563;border-top:4px solid #53ad2f;color:#ffffff;font-size:12px;line-height:1.55">CERTIFICAÇÃO DIGITAL É SEGURANÇA, AGILIDADE E CONFIANÇA.<br><span style="color:#d3dfeb">pedrozacertificadora.com.br • (21) 99167-4117</span></td></tr></table></td></tr></table></body></html>';
}
